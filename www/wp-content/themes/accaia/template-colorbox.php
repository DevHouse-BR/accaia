      					...
      					<div id="gallery_colorbox" class="gallery">
    					   <ul class="gallery_<?php echo $no_of_page_columns;?>">							
							<?php 
								...
								?>
									<li><a href="<?php echo wp_get_attachment_url($attachment->ID);?>" class="image" title="<?php if($data["wm_gallery_titles_colorbox"] == "Enable Colorbox Titles") { echo $post_title; } ?>" rel="gallery"><img src="<?php echo $url_post_img;?>" alt="<?php if($data["wp_gallery_titles_colorbox"] == "Enable Colorbox Titles") { echo $attachment->post_title; } ?>" title="<?php if($data["wp_gallery_titles_colorbox"] == "Enable Colorbox Titles") { echo $attachment->post_title; } ?>"/></a></li>									
							<?php
								   }
								}
							?>								
