    			...
    			<!-- Content has class "content_full_width" -->
  				<div id="content" class="content_full_width">
     				...
     				<div class="post">
							...
							<h3 class="post_title"><?php if ( $data['wm_custom_404_title']!= "" ) {?><?php echo $data['wm_custom_404_title'];?><?php } else { ?><?php _e('The page you\'re looking for isn\'t available...', 'kslang'); ?><?php } ?></h3>
