...
<?php
 ...
 $body_overlay_home = "";
  ...
  elseif( $data['wm_grid_hide_enabled'] == "Enable the Grid Overlay on All Pages" ){
...
?>
	...
	<div id="wrapper">
		<?php if(is_home()) {?>
			...
			<div id="pai">
				<div id="filho">
					<img id="accaia_logo" src="<?php echo home_url(); ?>/wp-content/uploads/2014/03/logo-central.png" />
				</div>
			</div>
		<?php } ?>
		...
		<div id="menu_wrap">
		    ...
		    <div id="hide_menu">   
		    	<a href="#" class="menu_visible">Esconder Menu</a> 
					
					<?php if ( $data['wm_menu_tooltip_enabled'] == "1" ) {?>
		        	<div class="menu_tooltip">
						
                        <div class="tooltip_hide"><p><?php _e('Esconder o Menu', 'kslang'); ?></p></div>
						<div class="tooltip_show"><p><?php _e('Exibir o Menu', 'kslang'); ?></p></div>
...
<?php 
	...
	<?php
	if($data['wm_slider_contents'] == 'Display Title & Description' || $data['wm_slider_contents'] == 'Display Title' || $data['wm_slider_contents'] == 'Display Description'){
	?>	
