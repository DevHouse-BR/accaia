      				...
      				<!-- Galleria - place you images here -->
      					...
      					<div id="gallery_galleria">    					   					
							<?php 
								...
								?>								
									<img src="<?php echo $url_post_img;?>" title="<?php if($data["wm_gallery_titles_galleria"] == "Enable Galleria Titles") { echo $attachment->post_title; } ?>" alt="<?php if($data["wm_gallery_titles_galleria"] == "Enable Galleria Titles") { echo $attachment->post_content; } ?>"/>
							<?php
								   }
								}
							?>	
