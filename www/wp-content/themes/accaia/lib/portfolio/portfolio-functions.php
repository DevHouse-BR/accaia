...
function kingsize_thumb_box($postid) {
	...
	$arr_main_img_300 = explode("-300x",$overview_image);
	$arr_main_img_200 = explode("-220x",$overview_image);
	$arr_main_img_160 = explode("-160x",$overview_image);
	$arr_main_img_112 = explode("-112x",$overview_image);
	if(count($arr_main_img_300)>1)
		$overview_image  = $arr_main_img_300[0].".".$overview_image_extension;
	elseif(count($arr_main_img_220)>1)
		$overview_image  = $arr_main_img_220[0].".".$overview_image_extension;
	elseif(count($arr_main_img_160)>1)
		$overview_image  = $arr_main_img_160[0].".".$overview_image_extension;
	elseif(count($arr_main_img_112)>1)
		$overview_image  = $arr_main_img_112[0].".".$overview_image_extension;
	################ END PORTFOLIO MAIN IMAGE ############
