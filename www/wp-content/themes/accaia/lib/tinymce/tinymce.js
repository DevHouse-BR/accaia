...
function insertkingsizeLink() {
	...
	var style = document.getElementById('shortcode_panel');
		...
		if (styleid != 0 && styleid == 'button') {
			tagtext = "["+ styleid + " to=\"#\" color=\"\" ]Button Text[/" + styleid + "]";	
		}
		...
		if (styleid != 0 && styleid == 'video') {
			tagtext = "["+ styleid + " name=\"\" url=\"\" width=\"460\" height=\"315\" ][/" + styleid + "] ";	
		}
		...
		if (styleid != 0 && styleid == 'img_gallery') {
			tagtext = "["+ styleid + " id=\"\" type=\"\" layout=\"\" orderby=\"\" order=\"\" description=\"\" placement=\"\" ] ";	
		}
