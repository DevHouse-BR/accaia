...
$slider_meta_box_settings = array(
	...
	/* Slider background options V4 */
		array( "name" => "Disable the Learn More link",
		  ...
		  "type" => "select",
		  "options" => array("enable_button"=>"Enabled Slider Button","disable_button"=>"Disable Slider Button"),
		  "std" => "enable_button",
		  "desc" => "Disable the Learn More link.",
		),
		...
		array( "name" => "Show Title and Description",
		  "id" => "kingsize_show_title_and_discription",
		  "type" => "select",
		  "options" => array("show_title_discription"=>"Show Title and Description","show_title"=>"Show Title Only", "show_discription"=>"Show Description  Only"),
		  "std" => "show_title_discription",
		  "desc" => "Show Title and Description of slider.",
		),
