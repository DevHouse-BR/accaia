...
<!-- Leave a comment box -->										
	<div id="respond">
		<h3 class="comments_head"><?php _e('Leave a reply', 'kslang'); ?></h3>	
		<p class="comment_info"><?php _e('Fields marked with * are required', 'kslang'); ?></p>	
		...
		<?php else : ?>
			<p><label class="name_label" for="form_name"><?php _e('Name', 'kslang'); ?>*</label>
			<input type="text" name="author" id='form_name' class="textbox" /></p>
				
			<p><label class="email_label" for="form_email"><?php _e('E-mail', 'kslang'); ?>*</label> 
			<input type="text" name="email" id='form_email' class="textbox"/></p>
					
			<p><label class="website_label" for="form_website"><?php _e('Website', 'kslang'); ?></label>
			<input type="text" name="url" id='form_website' class="textbox"/></p>
		<?php endif; ?>
		
			<p> <label class="message_label" for="form_message"><?php _e('Message', 'kslang'); ?>*</label> <textarea name="comment" id='form_message' rows="6" cols="25" class="textbox"></textarea> </p>
