...
?>
	...
	<style type="text/css">
		...
		#content h3, #footer_columns h3, #sidebar h3 {color: <?php echo $data['wm_heading_text_color_h3']; ?>;}
		...
		#wrapper #slidecaption {width: <?php echo $data['wm_slide_caption']; ?>px;}
	</style>
