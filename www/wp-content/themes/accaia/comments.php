	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-meta commentmetadata"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
			<?php
				...
				printf( __( '%1$s at %2$s', 'kslang' ), get_comment_date(),  get_comment_time() ); ?></a><?php edit_comment_link( __( '(Edit)', 'kslang' ), ' ' );
			?>
...
<?php if ( have_comments() ) : ?>
			...
			printf( _n( 'One Response to %2$s', '%1$s Responses to %2$s', get_comments_number(), 'kslang' ),
...
<?php else : // or, if we don't have comments:
	...
	if ( ! comments_open() ) :
?>
	<p class="nocomments"><?php _e( '', 'kslang' ); ?></p>
