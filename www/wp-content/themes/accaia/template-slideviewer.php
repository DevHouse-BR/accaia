      				 ...
      				 <div id="gallery_slideviewer" class="swv">  
						<ul class="gallery_shortcode_slideviewer">
							<?php 
								...
								?>	
									<li><img src="<?php echo $url_post_img;?>" alt="<?php 	if($data["wm_gallery_titles_slideviewer"] == "Enable SlideViewer Titles") { echo $attachment->post_title; } ?>" title="<?php if($data["wm_gallery_titles_slideviewer"] == "Enable SlideViewer Titles") { echo $attachment->post_title; } ?>"/></li> 
							<?php
								   }
								}
							?>	
