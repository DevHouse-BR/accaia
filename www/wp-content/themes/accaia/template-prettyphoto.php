<?php
/**
 Template Name: PrettyPhoto Page
 **/
global $data;
      					...
      					<div id="gallery_prettyphoto" class="gallery">
    					   <ul class="gallery_<?php echo $no_of_page_columns;?>">							
							<?php 
								...
								?>
									<li><a href="<?php echo wp_get_attachment_url($attachment->ID);?>" class="image" title="<?php if($data["wm_gallery_titles_prettyphoto"] == "Enable PrettyPhoto Titles") { echo $post_title; } ?>" rel="prettyPhoto[gallery]"><img  src="<?php echo $url_post_img;?>" alt="<?php  if($data["wm_gallery_titles_prettyphoto"] == "Enable PrettyPhoto Titles") { echo $attachment->post_title; } ?>" title="<?php if($data["wm_gallery_titles_prettyphoto"] == "Enable PrettyPhoto Titles") { echo $attachment->post_title; } ?>"/></a></li>									
							<?php
								   }
								}
							?>								
